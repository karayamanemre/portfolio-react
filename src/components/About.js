    ...
    <section className='section' id='about'>
      ...
      <div className={[styles.about_center, "section-center"].join(' ')}>
        <article className={styles.about_info}>
          <p>
            I attended Microverse Coding School and participated in daily remote team programming sessions. 
          </p>
          <p>  
            Before software development, I managed pubs and restaurants. Although not development-related, I learned problem-solving, effective communication, multitasking, and more. I've been rewarded for my quality and customer service, and I bring the same passion to my software engineering. I'm also a musician and composer. I produce my own music from scratch. I want to use my creativity to design software.
          </p>
          <p>
